...
import { Phone, Mail, MapPin, Camera, Edit2, ShieldCheck } from "lucide-react";
...
export function AdminProfile() {
  ...
  return (
    <div className="max-w-lg mx-auto">
      <BackButton to="/admin/dashboard" label="Back" />
      ...
      <div className="card">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <span>{(userProfile as any).address?.barangay || "No barangay set"}</span>
          </div>
        </div>
